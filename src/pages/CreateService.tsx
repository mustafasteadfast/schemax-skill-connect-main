...
export default function CreateService() {
  ...
  const handleCategoryChange = async (categoryId: string) => {
    ...
    if (categoryId) {
      // Mock subcategories data - in a real app, this would come from an API
      const mockSubcategories = [
        { id: 'sub-1', name: 'React Development' },
        { id: 'sub-2', name: 'Vue.js Development' },
        { id: 'sub-3', name: 'Angular Development' },
        { id: 'sub-4', name: 'Node.js Development' }
      ];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Mock service creation - in a real app, this would call an API
      const serviceData = {
        id: `service-${Date.now()}`,
